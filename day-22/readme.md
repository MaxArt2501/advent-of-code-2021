...
After running the above reboot steps, **`2758514936282235`** cubes are **on**. (Just for <span title="Well, *I* think it's fun.">fun</span>, `474140` of those are also in the initialization procedure region.)
